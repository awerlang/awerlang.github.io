(function e(t, n, r) {
        ...
        (function(process, global) {
            (function(undefined) {
                ...
                observableProto.windowWithTime = function(timeSpan, timeShiftOrScheduler, scheduler) {
                    ...
                    return new AnonymousObservable(function(observer) {
                        var groupDisposable, nextShift = timeShift,
                            nextSpan = timeSpan,
                            q = [],
    ...
    34: [function(require, module, exports) {
        ...
        "./hooks/attribute-hook": 28,
        "./index.js": 31,
        "./svg-attribute-namespace": 33,
        "x-is-array": 20
    }],
    ...
    49: [function(require, module, exports) {
        ...
        function replaceStreamName(vtree, eventName, view) {
            ...
            if (!Utils.endsWithDolarSign(streamName)) {
                throw new Error("VTree event hook should end with dollar sign $. " + "Name `" + streamName + "` not allowed.")
            }
            if (!view[streamName]) {
    ...
    50: [function(require, module, exports) {
        ...
        function getEventsOrigDestMap(vtree) {
            var map = {};
            for (var key in vtree.properties) {
                if (vtree.properties.hasOwnProperty(key) && typeof key === "string" && key.search(/^on[a-z]+/) === 0) {
        ...
        function getOriginEventStreams(dataFlowNode) {
            if (!(dataFlowNode instanceof DataFlowNode) || !Array.isArray(dataFlowNode.outputStreams)) {
                return {}
            }
            return dataFlowNode.outputStreams.filter(function(streamName) {
        ...
        function subscribeAndForward(origin$, destination$) {
            origin$.subscribe(function onNextWidgetEvent(x) {
                destination$.onNext(x)
            }, function onErrorWidgetEvent(e) {
                destination$.onError(e)
            }, function onCompletedWidgetEvent() {
        ...
        function forwardOriginEventsToDestinations(events, origDestMap) {
            for (var originStreamName in events) {
                if (events.hasOwnProperty(originStreamName) && origDestMap.hasOwnProperty(originStreamName)) {
    ...
    58: [function(require, module, exports) {
        ...
        Renderer.registerCustomElement = function registerCustomElement(tagName, dataFlowNode) {
            if (typeof tagName !== "string" || typeof dataFlowNode !== "object") {
                throw new Error("registerCustomElement requires parameters `tagName` and " + "`dataFlowNode`.")
            }
            if (!dataFlowNode.get("vtree$")) {
                throw new Error("The dataFlowNode for a custom element must export " + "`vtree$`.")
            }
            tagName = tagName.toUpperCase();
            if (Renderer._customElements && Renderer._customElements.hasOwnProperty(tagName)) {
                // afw: throw => return
                return new Error("Cannot register custom element `" + tagName + "` " + "in Renderer because that tagName is already registered.")
            }
        ...
        var DiagramCompletionComponentView = Cycle.createView(function(Model) {
            ...
            var vrender = function(time, isDraggable, isTall, inputStyle, isHighlighted) {
                ...
                return h("div", {
                    style: mergeStyles({
                        left: "" + time + "%"
                    }, containerStyle, isDraggable ? draggableContainerStyle : {}),
    ...
    64: [function(require, module, exports) {
        ...
        module.exports = Cycle.createView(function(Model) {
            ...
            var vrenderDiagram = function(data, isInteractive) {
                ...
                return h("div", {
                    style: diagramStyle
                }, [vrenderDiagramArrow(), vrenderDiagramArrowHead(), h("div", {
                    style: diagramBodyStyle
                }, [completionVTree].concat(marblesVTree))])
            };
            var MARBLE_WIDTH = 5;
    ...
    67: [function(require, module, exports) {
        ...
        cyclejs: 51,
        immutable: 60,
        "rxmarbles/components/sandbox/utils": 70
    }],
    ...
    69: [function(require, module, exports) {
        ...
        var SandboxComponentView = Cycle.createView(function(Model) {
            ...
            var vrenderOperator = function(label) {
                ...
                return h("div", {
                    style: style
                }, [elevation2Before, vrenderOperatorLabel(label), elevation2After])
            };
            ...
            return {
                vtree$: Rx.Observable.combineLatest(Model.get("inputDiagrams$"), Model.get("operatorLabel$"), Model.get("outputDiagram$"), Model.get("width$"), function(inputDiagrams, operatorLabel, outputDiagram, width) {
                    return h("div", {
                        style: getSandboxStyle(width)
                    }, [inputDiagrams.get("diagrams").map(function(diagram) {
                        return h("x-diagram", {
                            data: diagram,
                            interactive: true,
                            onnewdata: "diagramNewData$"
                        })
                    }), vrenderOperator(operatorLabel), h("x-diagram", {
                        data: outputDiagram,
                        interactive: false
                    })])
                })
    ...
    81: [function(require, module, exports) {
        ...
        var elevation2Before = exports.elevation2Before = h("div", {
            style: getElevationPseudoElementStyle("2px", "10px", "0.17")
        }, "");
        var elevation2After = exports.elevation2After = h("div", {
            style: getElevationPseudoElementStyle("2px", "5px", "0.26")
        }, "");
        var elevation3Before = exports.elevation3Before = h("div", {
            style: getElevationPseudoElementStyle("6px", "20px", "0.19")
        }, "");
        var elevation3After = exports.elevation3After = h("div", {
            style: getElevationPseudoElementStyle("6px", "17px", "0.2")
        }, "");
